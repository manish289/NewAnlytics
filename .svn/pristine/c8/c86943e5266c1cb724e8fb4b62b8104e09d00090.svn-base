...
@NoArgsConstructor
@ToString
public class CompareTenderStateDto {
	...
	public BigDecimal getParticipated_tender_count() {
		return participated_tender_count==null?new BigDecimal(0):participated_tender_count;
	}

	public void setParticipated_tender_count(BigDecimal participated_tender_count) {
	...
	public BigDecimal getAward_result_count() {
		return award_result_count==null?new BigDecimal(0):award_result_count;
	}

	public void setAward_result_count(BigDecimal award_result_count) {
